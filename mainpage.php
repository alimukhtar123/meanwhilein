...
$log=$stmt->fetch(PDO::FETCH_ASSOC);
 ...
 <form class="form" method="post" action="mainpagecsc343.php">
    <div class="adress">
	<h4>Welcome <?php echo  $log['name'] ?>!</h4>
        <h4>Please enter the address of the place that you want to rent</h4>
        ...
        <button type="submit" class="btn btn-primary btn-block btn-large">Rent my house.</button>
</div>
 </form>  
      
        <form class="form" method="POST" action="main.php">
   
        <button type="submit" class="btn btn-primary btn-block btn-large "  >Return to mainpage.</button>
